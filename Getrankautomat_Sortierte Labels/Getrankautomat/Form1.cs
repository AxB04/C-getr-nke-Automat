namespace Getrankautomat
{
    public partial class Form1 : Form
    {
        ...
        private void PreisAusgabe()
        {
            ...
            label7.Text = "Preis: " + Convert.ToString(Preis) + " Euro";
        }
        #endregion
        private void button6_Click(object sender, EventArgs e)
        {
            if (Geld != 0 && Preis < Geld)
            {
                ...
                {
                    label8.Text = "Ruckgeld: " + Convert.ToString(Ruckgeld) + " Euro";
                    label1.Text = "Apfelschorlen Sirup: " + Convert.ToString(Apfelschorlensirup);
                    label2.Text = "Fanta Sirup: " + Convert.ToString(Fantasirup);
                    label3.Text = "Cola Sirup: " + Convert.ToString(Colasirup);
                    label4.Text = "0,3 Becher: " + Convert.ToString(kleineBecher);
                    label5.Text = "0,4 Becher: " + Convert.ToString(grosseBecher);

                    Ruckgeld = 0;
                    Geld = 0;
                    label6.Text = "Geld Input: ";
                }
            }
        ...
        {
            label6.Text = "Geld Input: " + Math.Round(Geld, 2);
        }
        #endregion
    }
}